...
nyms={}; //we'll access nyms by fingerprint
nym = function(nick, fp) {
    this.nick=nick; this.fp=fp; 
};
addNym = function(nick,fp) {
    newNym=new nym(nick,fp);
    nyms[fp.toString()]=newNym;
};
...
savebutton=document.getElementById("saveHexData");
savebutton.onclick=function() {
    console.log("button clicked");
    Sexy.socket.emit("saveClicked", document.getElementById("info").value);
